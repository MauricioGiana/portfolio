                    ...
                    <div className="row contact-container">
                      <div className="col-md-6">
                        <div className="title-box-2">
                          <h5 className="title-left">{this.contact.formTitle}</h5>
                        </div>
                        <div>
                          <form
                              ...
                              <div className="col-md-12 mb-3">
                                <div className="form-group">
                                  <input
                                    ...
                                    id="name"
                                    placeholder={this.contact.labels[0]}
                                    data-rule="minlen:4"
                                    data-msg={this.contact.labels[1]}
                                  />
                              ...
                              <div className="col-md-12 mb-3">
                                <div className="form-group">
                                  <input
                                    ...
                                    name="email"
                                    id="email"
                                    placeholder={this.contact.labels[2]}
                                    data-rule="email"
                              ...
                              <div className="col-md-12 mb-3">
                                <div className="form-group">
                                  <input
                                    ...
                                    name="subject"
                                    id="subject"
                                    placeholder={this.contact.labels[3]}
                                    data-rule="minlen:4"
                              ...
                              <div className="col-md-12 mb-3">
                                <div className="form-group">
                                  <textarea
                                    ...
                                    placeholder={this.contact.labels[4]}
                                  ></textarea>
                                  <div className="validation"></div>
                                </div>
                              </div>
                      ...
                      <div className="col-md-6">
                        <div className="title-box-2 pt-4 pt-md-0">
                          <h5 className="title-left">{this.contact.title}</h5>
                        </div>
